...
public class MyDateUtils {
    ...
    public static long strToLong(String dateStr) {
        mDateFormat = new SimpleDateFormat("yyyy年MM月dd日  HH:mm", Locale.getDefault());
    ...
    /**string转long
     * @param dateStr yyyy年MM月dd日  HH:mm:ss SSS
     * @return 返回long型时间，失败返回-1
     */
    public static long strToLong(String dateStr,String sdf) {
