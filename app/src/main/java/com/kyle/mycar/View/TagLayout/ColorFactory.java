...
package com.kyle.mycar.View.TagLayout;
...
//    public static final String AMBER = "FFC107";
    public static final String AMBER = "FFA000";
    ...
    public static final int SHARP666666 = Color.parseColor("#FFFFFFFF");
...
//            LIME, BLUE, INDIGO, LIGHTGREEN, GREY, DEEPPURPLE, TEAL, CYAN};
    private static final String[] COLORS = new String[]{RED, LIGHTBLUE, ORANGE,AMBER,
            BLUE, INDIGO, LIGHTGREEN, GREY, DEEPPURPLE, TEAL, CYAN};
