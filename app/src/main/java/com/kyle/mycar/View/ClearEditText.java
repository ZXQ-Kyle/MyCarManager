...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText {
     ...
     * 默认的清除按钮图标资源
     */
    private static final int ICON_CLEAR_DEFAULT = R.drawable.ic_clear;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int color = typedArray.getColor(R.styleable.ClearEditText_iconTint, getResources().getColor(R.color.colorAccent));
        drawableClear = getResources().getDrawable(iconClear);
        drawableClear  = Tint.tintDrawable(drawableClear, color);
        updateIconClear();
        typedArray.recycle();
    ...
    public void updateIconClear() {
        ...
        {
            setCompoundDrawablesWithIntrinsicBounds(drawables[0], drawables[1], drawableClear, drawables[3]);
        } else {
