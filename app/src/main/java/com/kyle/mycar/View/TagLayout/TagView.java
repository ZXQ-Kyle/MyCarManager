...
import static com.kyle.mycar.View.TagLayout.Utils.dp2px;
 ...
 */
public class TagView extends View implements Checkable {
    ...
    public TagView(Context context, String text,boolean checkable) {
        super(context);
